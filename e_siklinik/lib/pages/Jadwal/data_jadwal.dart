...
class _DataJadwalState extends State<DataJadwal> {
  final String apiGetAllJadwalDokter =
      "http://192.168.1.70:8080/api/jadwal_dokter";
  ...
  void _deleteItem(int id) async {
    Uri url =
        Uri.parse('http://192.168.1.70:8080/api/jadwal_dokter/delete/$id');
              ...
              child: jadwalList.isEmpty
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Tidak ada data jadwal dokter',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),)
                  ],
                ),
              )
                  : SafeArea(
