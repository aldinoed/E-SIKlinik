...
class _AddAssessmentState extends State<AddAssessment> {
  ...
  final String apiPostAssesment =
      "http://192.168.0.107:8000/api/checkup-assesmen/insert";
  List<dynamic>? antrianDetail;

  final String apiGetAllDokter = "http://192.168.0.107:8000/api/dokter";
  ...
  Future<void> _getAntrianDetail() async {
    try {
      final response = await http.get(
        Uri.parse(
            "http://192.168.0.107:8000/api/antrian/show/${widget.antrianId}"),
      );
      if (response.statusCode == 200) {
        final data = json.decode(response.body);
