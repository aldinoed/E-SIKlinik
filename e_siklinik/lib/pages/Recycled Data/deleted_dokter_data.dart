...
class _DeletedDokterDataState extends State<DeletedDokterData> {
  final String apiGetAllDokter = "http://192.168.0.107:8000/api/dokter/deleted-dokter";
  ...
  Future<void> _enableDokter(int dokterId) async {
    try {
      final response = await http.put(Uri.parse("http://192.168.0.107:8000/api/dokter/aktif/$dokterId"));
      if (response.statusCode == 200) {
        final data = json.decode(response.body);
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                ...
                                return BoxDokter(
                                  ...
                                  icon: 'http://192.168.0.107:8000/storage/' +
                                      dokter['image'],
                                  nama: dokter['nama'] ?? '',
                                  onTapPop: () {
