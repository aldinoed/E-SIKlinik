...
class _DataPasienState extends State<DataPasien> {
  final String apiGetAllPasien = "http://192.168.0.5:8080/api/pasien";
  ...
  Future<void> _disablePasien(int pasienId) async {
    try {
      final response = await http
          .put(Uri.parse("http://192.168.0.5:8080/api/pasien/disabled/$pasienId"));
      if (response.statusCode == 200) {
        final data = json.decode(response.body);
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                ...
                                return BoxPasien(
                                  ...
                                  icon: 'http://192.168.0.5:8080/storage/' +
                                      pasien['image'],
                                  onTapPop: () {
