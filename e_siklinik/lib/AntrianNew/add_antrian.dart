...
class _AddAntrianNewState extends State<AddAntrianNew> {
  ...
  final String apiPostAntrian = "http://192.168.24.175:8080/api/antrian/create";
  final String apiGetAllPasien = "http://192.168.24.175:8080/api/pasien";
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                  image: NetworkImage(
                                      'http://192.168.24.175:8080/storage/' + selectedPasien!['image']),
                                  fit: BoxFit.fill)),
                        ),
                        const SizedBox(height: 15),
